...
const programDescription =
  "Это программа для тех, кто хочет не просто познакомиться с таро, а научиться видеть глубже, понимать структуру расклада, развивать интуицию и работать с картами осознанно, уверенно и профессионально. Здесь вы получаете не хаотичный набор знаний, а выстроенную систему обучения, где каждый тариф ведёт вас от первых шагов к более глубокому пониманию таро.";

const results = [
  "Понятную и структурную систему обучения",
...
const tariffs = [
  {
    name: "База",
    subtitle: "Подходит тем, кто хочет начать с прочной основы и изучать самостоятельно",
    features: [
      "Полный комплект материалов для самостоятельного изучения",
      "Знакомство с основами и логикой системы",
      "Пошаговое погружение в тему таро",
      "Возможность изучать материалы в комфортном темпе",
      "Бессрочный доступ ко всем материалам тарифа",
    ],
    result: "Вы получаете уверенное базовое понимание системы, структуру для самостоятельной работы и основу, на которой можно строить дальнейшее обучение.",
    price: "13 000 ₽",
    accent: false,
  },
  {
    name: "Глубина",
    subtitle: "Подходит тем, кто хочет не просто читать материалы, а действительно осваивать таро в практике",
    features: [
      "Все материалы тарифа «База»",
      "Расширенная программа обучения",
      "Домашние задания для закрепления знаний",
    ...
    result: "Вы начинаете чувствовать карты увереннее, глубже понимать их смысл, развивать интуицию и получать поддержку в процессе обучения.",
    price: "33 000 ₽",
    accent: false,
  },
  {
    name: "Личное сопровождение",
    subtitle: "Подходит тем, кто хочет идти в обучении быстро, глубоко и с личной обратной связью",
    features: [
      "Всё из тарифов «База» и «Глубина»",
      ...
      "Подарок: курс по диагностике негатива на классической колоде Уэйта",
    ],
    result: "Вы проходите программу в интенсивном формате, быстрее растёте в понимании таро, получаете персональное сопровождение и движетесь к уверенной самостоятельной практике.",
    price: "69 000 ₽",
    accent: true,
  },
];
